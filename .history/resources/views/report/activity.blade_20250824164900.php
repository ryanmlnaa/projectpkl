            ...
            <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                ...
                <div class="btn-group" role="group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('reports.exportPdf') }}">🖨️ Print to PDF</a></li>
                        <li><a class="dropdown-item" href="{{ route('reports.exportCsv') }}">📊 Export CSV</a></li>
                        <li><a class="dropdown-item" href="{{ route('reports.export', ['format' => 'json']) }}">💾 Export JSON</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="{{ route('reports.print') }}" target="_blank">🖨️ Print View</a></li>
                    </ul>
                </div>
            </div>
            <div class="card-body">
