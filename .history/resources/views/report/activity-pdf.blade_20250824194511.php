   ...
   <table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <!-- Evidence fix untuk DomPDF -->
            <td class="text-center">
                @php
                    $evidencePath = public_path('storage/'.$report->evidence);
                @endphp

                @if($report->evidence && file_exists($evidencePath))
                    <img src="{{ $evidencePath }}" width="100">
                @else
                    (Tidak ada)
                @endif
            </td>
