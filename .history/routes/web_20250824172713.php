...
Route::get('/activity/export-pdf', [ReportActivityController::class, 'exportPdf'])->name('report.activity.export.pdf');

// Atau jika menggunakan resource route:
Route::resource('activity', ReportActivityController::class);
// Tambahkan route khusus untuk export
Route::get('/activity/export-pdf', [ReportActivityController::class, 'exportPdf']);
