            ...
            <form action="{{ route('report.operational.store') }}" method="POST" class="mb-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="latitude" class="form-control" placeholder="-6.200000" value="{{ old('latitude') }}">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Longitude</label>
                        <input type="text" name="longitude" class="form-control" placeholder="106.816666" value="{{ old('longitude') }}">
                    </div>
                    <div class="col-12">
