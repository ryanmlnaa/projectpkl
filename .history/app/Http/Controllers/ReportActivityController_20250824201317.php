...
class ReportActivityController extends Controller
{
    ...
    {
        $clusters = Competitor::select('cluster')->distinct()->pluck('cluster');
        return view('report_activity.create', compact('clusters'));
    }

    public function index(Request $request)
    {
        $query = ReportActivity::query();

    // 🔎 Search filter by cluster
