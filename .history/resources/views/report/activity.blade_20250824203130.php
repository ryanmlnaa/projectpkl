...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('report-activities.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <!-- Cluster (Dropdown dari Competitor) -->
    <div class="form-group">
    ...
    <!-- Hasil Kendala -->
    <div class="form-group">
        <label for="hasil_kendala">Hasil / Kendala</label>
        <textarea name="hasil_kendala" class="form-control"></textarea>
    </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="cluster" class="form-control" required>
                                                            @foreach(range('A', 'J') as $cluster)
                                                                <option value="{{ $cluster }}" {{ $report->cluster == $cluster ? 'selected' : '' }}>
                                                                    {{ $cluster }}
                                                                </option>
                                                            @endforeach
                                                        </select>
