            ...
            fetch(url)
                ...
                .then(data => {
                    if (data.kode_fat) {
                        ...
                        setTimeout(() => kodeFatInput.classList.remove('fat-updated'), 1200);
                    } else {
                        kodeFatInput.value = '';
                    }
                })
...
function updateCoordinates(lat, lng) {
    ...
    document.getElementById('display-lat').textContent = formattedLat;
    document.getElementById('display-lng').textContent = formattedLng;
}
