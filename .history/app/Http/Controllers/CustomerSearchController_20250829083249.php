...
class CustomerSearchController extends Controller
{
     ...
     * FIXED: Return dengan view path yang benar sesuai Blade template
     */
    public function index(Request $request)
    {
        ...
        // PENTING: Kembalikan ke view path yang sesuai dengan @extends di Blade
        return view('customer.search', compact('pelanggans', 'filterField', 'filterQuery'));
    }

    /**
     * Advanced search dengan multiple filters
     * FIXED: Method name sesuai dengan route
     */
    public function advancedSearch(Request $request)
    {
        ...
        return view('customer.search', compact('pelanggans', 'filterField', 'filterQuery', 'isAdvancedSearch'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            if (request()->ajax()) {
                return view('customer.edit-form', compact('pelanggan'))->render();
            }

            return view('customer.edit', compact('pelanggan'));
        } catch (\Exception $e) {
            if (request()->ajax()) {
     ...
     * FIXED: Method yang benar untuk delete via AJAX
     */
    ...
    public function showMap(Request $request)
    {
        ...
        return view('customer.map', compact('pelanggans'));
    }

    /**
     * Get detail pelanggan untuk modal
     */
    public function getDetail($id)
    {
        try {
            ...
            $html = view('customer.detail-modal', compact('pelanggan'))->render();
    ...
    /**
     * Export search results (placeholder)
     */
